    ...
    return <section className="relative pt-32 lg:pt-36">
        <Container className="flex flex-col lg:flex-row  gap-10 lg:gap-12">
            <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-0">
                ...
                <span className="absolute right-4 bottom-14 w-24  h-24  rounded-3xl bg-primary blur-xl-opacity-80"></span>
            </div>
            ...
            lg:max-w-none max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2">
                <h1 className="text-heading-1  text-3xl sm:text-4xl md:text-5xl ml:text-6xl font-bold ">Empower Your Bussiness <span
